...
namespace QBOAccountChecker.Controllers
{
    public class CallbackController : Controller
    {
        ...
        private async Task GetAuthTokensAsync(string code, string realmId)
        {
            ...
            {
                claims.Add(new Claim("identity_token", tokenResponse.IdentityToken));
                claims.Add(new Claim("identity_token_expires_at", (DateTime.Now.AddSeconds(tokenResponse.RefreshTokenExpiresIn)).ToString()));
            }
